...
**Project:** EpicStaff
**Licensor:** HYS Enterprise B.V.
**Copyright (c) 2026 HYS Enterprise B.V.**
...
The licensor is HYS Enterprise B.V., the entity offering these terms.

The software is the EpicStaff software made available by HYS Enterprise B.V. under these terms, including the source code, object code, documentation, and related materials included in the relevant repository or release.
