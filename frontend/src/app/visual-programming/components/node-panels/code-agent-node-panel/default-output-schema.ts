export const DEFAULT_OUTPUT_SCHEMA: Record<string, unknown> = {
    ...
    properties: {
        ...
        ef_tables: {
            type: 'array',
            description:
                "Interactive data tables below the message. Each object needs at minimum a 'rows' array of objects.",
            items: { type: 'object' },
        },
        action_message: {
            type: 'array',
