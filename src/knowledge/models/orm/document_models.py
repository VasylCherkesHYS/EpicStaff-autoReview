...
class EmbeddingConfig(Base):
    ...
    task_type = Column(String(255), nullable=False, default="retrieval_doc")  # or EmbedderTask default
...
class SourceCollection(Base):
    ...
    document_metadata = relationship("DocumentMetadata", back_populates="source_collection", cascade="all, delete-orphan")
    embeddings_coll = relationship("DocumentEmbedding", back_populates="collection", cascade="all, delete-orphan")
...
class DocumentEmbedding(Base):
    ...
    chunk_id = Column(
        Integer,
        ForeignKey("tables_chunk.id", ondelete="SET NULL"),
        nullable=True
    )
